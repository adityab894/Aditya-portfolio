...
export default function Wizard(props) {
  ...
  return (
    ...
    >
      ...
      />
      <mesh
        name="R_shoe_tongue_mesh_BLN_Shoe_tongue_0"
        castShadow
        receiveShadow
      ...
      />
      <mesh
        name="Chest_piece_mesh_BLN_chest_piece_0"
        castShadow
        receiveShadow
      ...
      />
      <mesh
        name="Right_Eyeball_Mesh_Lam_eyeball_0"
        castShadow
        receiveShadow
      ...
      />
      <mesh
        name="lower_coat_mesh_FK_BLN_Lower_coat_0"
        castShadow
        receiveShadow
      ...
      />
      <mesh
        name="Upper_coat_mesh_BLN_upper_coat_0"
        castShadow
        receiveShadow
      ...
      />
      <mesh
        name="upper_body_mesh_BLN_shirt_0"
        castShadow
        receiveShadow
      ...
      />
      <mesh
        name="upper_body_mesh_BLN_Shirt_collar_0"
        castShadow
        receiveShadow
      ...
      />
      <mesh
        name="Coat_collar_mesh_BLN_collar_piece_0"
        castShadow
        receiveShadow
      ...
      />
      <mesh
        name="BookpolySurface5_Bookblinn1_0"
        castShadow
        receiveShadow
      ...
      />
      <mesh
        name="BookBook_corner_mesh4_Booklam_book_corners_0"
        castShadow
        receiveShadow
      ...
      />
      <mesh
        name="BookpolySurface20_BookBLN_Metal_parts_0"
        castShadow
        receiveShadow
      ...
      />
      <mesh
        name="BookFront_glow_mesh_Booklambert8_0"
        castShadow
        receiveShadow
      ...
      />
      <mesh
        name="BookpolySurface2_BookBLN_Book_covers_0"
        castShadow
        receiveShadow
      ...
      />
      <mesh
        name="BookpCube10_Booklam_front_bits_0"
        castShadow
        receiveShadow
      ...
      />
      <mesh
        name="BookpolySurface28_Booklam_back_bits_0"
        castShadow
        receiveShadow
      ...
      />
      <mesh
        name="Evil_HatpPlane1_Evil_HatsolidShader_0"
        castShadow
        receiveShadow
