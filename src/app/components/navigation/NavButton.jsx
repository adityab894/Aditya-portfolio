...
style={{transform: `translate(${x}, ${y})` }} > 
    ...
    className="text-foreground rounded-full flex items-center justify-center bg-background/20 border border-accent/30 border-solid backdrop-blur-[6px] shadow-glass-insert hover:shadow-glass-sm"
