"use client";
import { create } from "framer-motion";  // Import create from framer-motion
...
const MotionButton = create(motion.button);  // Create MotionButton using create()
  ...
  return (
    <div className="fixed top-4 right-2.5 xs:right-4 z-50 group">
      ...
      <audio ref={audioRef} loop>
        <source src={"/audio/portfolio.mp3"} type="audio/mpeg" />
